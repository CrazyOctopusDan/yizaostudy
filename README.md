...
本项目是一个 Windows 本地运行的一级造价师学习推进网页。它面向 2026 年一级造价工程师（土木建筑工程）备考，核心能力包括知识点级每日任务、科目勾选、角色等级 EXP、真题/错题记录、资料链接和外部考试得分记录。
...
- 今日任务会写明具体知识点，例如“管理 / 工程造价管理及其基本制度 / 工程造价的基本内容”。
- 每个知识点可以打卡为 `已学`、`模糊`、`掌握`。
- 标记为 `模糊` 的知识点会进入复盘队列。
